...
2. Check out the required external components:
"""
./manage_externals/checkout_externals
"""

3. Navigate to the CIME scripts directory:
"""
cd my_cesm_sandbox/cime/scripts
"""

4. Create a new case (replace $USER with your username):
"""
./create_newcase --case /scratch/midway3/$USER/cases/b.e20.B1850.f19_g17.test --compset B1850 --res f19_g17
"""

5. Enter the newly created case directory:
"""
